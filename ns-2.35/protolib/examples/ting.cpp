...
//    from one round to the next, pruning old observations, etc.
// 
...
class TingMessage : public ProtoPkt
{
    public:
        ...
        static const double BACKOFF_MIN = 1.0e-06;
        static const double BACKOFF_MAX = 1000.0; 
...
void TingSession::Summarize()
{
    ...
    double offsetMin, offsetMax, offsetSum;
    unsigned int offsetCount = 0;
    double rttMin, rttMax, rttSum;
